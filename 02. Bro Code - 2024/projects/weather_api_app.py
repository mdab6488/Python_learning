...
class WeatherApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.setStyleSheet("""
            ...
            QLabel#emoji_label {
                font-size: 100px;
                font-family: "Segoe UI Emoji", "Apple Color Emoji", "Noto Color Emoji", "Android Emoji", "EmojiSymbols", "EmojiOne Mozilla", "Twemoji Mozilla", sans-serif;
            }
    ...
    def get_weather(self):
        api_key = "d3c136c1c164e0ac1cef45e83846ed94"
    ...
    def display_weather(self, data):
        ...
        temperature_data = data["main"]["temp"]
        temperature_c = temperature_data - 273.15
        # temperature_f = (temperature_data * 9/5) - 459.67
        # print(f"C: {temperature_c:.2f} F: {temperature_f:.2f}")
    ...
    def get_weather_emoji(weather_id):
        if 200 <= weather_id <= 232:
            ...
            return "🌡️"  # Default/unknown weather
